...
public class ParentService extends UserService {
	...
	public Response updateData(String userId, String parentId, String name, String surname, String day, String month,
			String year) {
		if (userId == parentId || isAdministrator(userId))
			return updateParentData(parentId, name, surname, day, month, year);
		else
			return Response.status(Status.UNAUTHORIZED).build();
	}

	public Response updateParentData(String id, String name, String surname, String day, String month, String year) {
